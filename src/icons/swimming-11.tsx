...
export const paths:string[] = [
  `M8.0039,0.4941l-0.6992,0.502L4.6035,2.5977	C4.3036,2.6967,4.2042,3.1962,4.4023,3.4961l0.5996,1.002l-2.5,2l1,1.002l2-1.002L7.5039,7.5l1-1.002l-3.002-3.502l3.002-1.5v-1.002
...
export default createSvgIcon(
  [<path key='s-0' id='path8421-9-1-0-7' d={paths[0]}/>],
  'Swimming11'
);
